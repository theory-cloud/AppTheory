...
- AppTheory: `github.com/theory-cloud/apptheory/v3/pkg/limited` (+ `pkg/limited/middleware`)
...
- Package: `github.com/theory-cloud/apptheory/v3/pkg/limited`
- net/http middleware: `github.com/theory-cloud/apptheory/v3/pkg/limited/middleware`
...
- AppTheory: `github.com/theory-cloud/apptheory/v3/pkg/services`
...
- `./scripts/migrate-from-lift-go.sh`:
  - Scope: rewrites `github.com/pay-theory/limited` → `github.com/theory-cloud/apptheory/v3/pkg/limited` (and subpackages)
