...
DELETE, task methods, task-augmented tool calls, resource subscriptions, or `subscriptions/listen`.
...
name/version under `_meta["io.modelcontextprotocol/serverInfo"]`. A subscriptions capability is intentionally absent.
