...
| `premain` | Prerelease branch. | `staging` promotion PRs only. |
| `main` | Stable release branch. | `premain` promotion PRs only. |
...
- The prerelease Release Please workflow may then create or update the release-candidate PR.
...
- The stable Release Please workflow may then create or update the stable release PR.
