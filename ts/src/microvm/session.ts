...
export function validateMicroVMSessionProviderFields(
  record: MicroVMSessionRecord,
...
export function normalizeMicroVMSessionRecord(
  record: MicroVMSessionRecord,
): MicroVMSessionRecord {
...
export function normalizeMicroVMSessionStatus(
  status: MicroVMSessionStatus,
...
export function cloneMicroVMSessionRecord(
  record: MicroVMSessionRecord,
): MicroVMSessionRecord {
  return normalizeMicroVMSessionRecord(record);
}

export function normalizeMicroVMSessionRegistryRecord(
  record: MicroVMSessionRegistryRecord,
): MicroVMSessionRegistryRecord {
...
export function cloneMicroVMSessionRegistryRecord(
  record: MicroVMSessionRegistryRecord,
): MicroVMSessionRegistryRecord {
  return normalizeMicroVMSessionRegistryRecord(record);
}

export function normalizeMicroVMSessionTokenMetadata(
  token: MicroVMSessionTokenMetadata,
): MicroVMSessionTokenMetadata {
  return {
...
export function cloneMicroVMSessionTokenMetadataList(
...
export function microVMSessionFromRegistryRecordNoValidate(
  record: MicroVMSessionRegistryRecord,
): MicroVMSessionRecord {
  const out: MicroVMSessionRecord = {
...
export function normalizeMicroVMSessionKey(
...
export function normalizeMicroVMSessionReconstructionRequest(
...
export function validateMicroVMSessionKey(key: MicroVMSessionKey): void {
...
export function microVMSessionRegistryRecordKey(
  record: MicroVMSessionRegistryRecord,
): string {
  return `${record.pk}\u0000${record.sk}`;
}

export function microVMSessionRegistryRecordKeyFromKey(
  key: MicroVMSessionKey,
): string {
  return `${microVMSessionRegistryPartitionKey(key.tenant_id, key.namespace)}\u0000${microVMSessionRegistrySortKey(key.session_id)}`;
}

export function microVMSessionRecordIsStale(
  record: MicroVMSessionRecord,
  now: Date,
  staleAfterMs: number,
): boolean {
...
export function registryRecordToTableItem(
  record: MicroVMSessionRegistryRecord,
...
export function registryRecordFromTableItem(
...
export function asMicroVMSessionRegistryError(
  err: unknown,
  requestID: string,
): MicroVMSafeError {
...
export function recordMapField(
  item: Record<string, unknown>,
  key: string,
...
export function recordStringListField(
  item: Record<string, unknown>,
  key: string,
): string[] {
  const raw = item[key];
...
export function recordTokenMetadataField(
  item: Record<string, unknown>,
  key: string,
): MicroVMSessionTokenMetadata[] | undefined {
  const raw = item[key];
...
export function microVMSessionRecordKey(record: MicroVMSessionRecord): string {
...
export function microVMSessionKeyString(
  tenantID: string,
  namespace: string,
  sessionID: string,
): string {
