...
export function forbiddenMicroVMFieldName(name: string): boolean {
...
export function validateSafeMicroVMMetadata(
...
export function validateSafeMicroVMFieldValue(
  value: string,
  requestID: string,
): MicroVMSafeError | null {
...
export function forbiddenMicroVMFieldValue(value: string): boolean {
...
export function missingStrings(required: string[], got: string[]): string[] {
