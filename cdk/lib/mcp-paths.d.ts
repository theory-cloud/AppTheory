 ...
 */
export declare abstract class AppTheoryMcpPaths {
    /** Conventional MCP endpoint path. */
    static readonly MCP = "/mcp";
    /** Generic RFC 9728 protected-resource metadata path. */
    static readonly OAUTH_PROTECTED_RESOURCE = "/.well-known/oauth-protected-resource";
    /** RFC 9728 protected-resource metadata path for the conventional MCP endpoint. */
    static readonly OAUTH_PROTECTED_RESOURCE_MCP = "/.well-known/oauth-protected-resource/mcp";
    /** RFC 8414 authorization-server metadata path for an MCP resource. */
    static readonly OAUTH_AUTHORIZATION_SERVER_MCP = "/.well-known/oauth-authorization-server/mcp";
}
