...
- Opt-in SecureApp routing requires Public, Optional, Authenticated, AuthenticatedAnyOf, or InternalOnly posture on
  every HTTP, AppSync, and WebSocket route while leaving legacy App behavior unchanged.
