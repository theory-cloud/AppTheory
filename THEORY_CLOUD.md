...
- **One path to runtime behavior.** [AppTheory](https://github.com/theory-cloud/AppTheory) provides a single
  ...
  code in Go, TypeScript, or Python produces the same HTTP response, verified by the contract fixture corpus. Go, TypeScript, and Python execute the SP09 MCP, SP12 OAuth, and SP13 objectstore fixtures as first-class contract tiers. <!-- apptheory-fixture-count: 241 -->
