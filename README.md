...
| | |
|---|---|
| **Contract test fixtures** | 194 total — Go and TypeScript execute all; Python passes 183 shared non-MCP fixtures and explicitly skips 11 MCP future-runtime fixtures | <!-- apptheory-fixture-count: 194 -->
...
- **Cross-language consistent** — one routing model, one middleware order, one error envelope — across three runtimes — with drift prevention on the shared non-MCP corpus. Go and TypeScript execute all [194 contract fixtures](https://apptheory.theorycloud.ai/reference/contract-fixtures/); Python passes the 183 shared non-MCP fixtures and explicitly skips the 11 MCP future-runtime fixtures pending SP11. <!-- apptheory-fixture-count: 194 -->
...
- [Contract Fixtures](https://apptheory.theorycloud.ai/reference/contract-fixtures/) — the 194-fixture covenant: Go and TypeScript execute all; Python skips 11 MCP future-runtime fixtures pending SP11 <!-- apptheory-fixture-count: 194 -->
...
| `contract-tests/` | Contract fixtures (194 total) + runners for Go, TS, Python; Go and TS execute the MCP tier while Python explicitly skips it pending SP11 | <!-- apptheory-fixture-count: 194 -->
