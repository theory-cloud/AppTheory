...
func DefaultSessionRegistryContract() SessionRegistryContract {
	...
	return SessionRegistryContract{
		...
		ForbiddenFields: []string{"raw_aws_credentials", "raw_lifecycle_hook_payload", "bearer_token", "session_token_plaintext", "x-aws-proxy-auth", "raw_provider_exception", "account_wide_list_token"},
	}
}
