# AppTheory Evidence Plan (Rubric v1.5.1)
...
| CMP-4 | Release lifecycle invariant verification | `gov-infra/evidence/CMP-4-output.log` | `bash gov-infra/verifiers/gov-verify-rubric.sh` |
