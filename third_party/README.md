...
`aws-cdk-lib-2.240.0+minimatch-10.2.4.tgz` is based on the upstream `aws-cdk-lib@2.240.0` npm tarball, with the
bundled `minimatch` dependency updated to `10.2.4` to address OSV findings (SEC-2).

Regeneration (example):

1) `npm pack aws-cdk-lib@2.240.0`
...
4) Repack as `aws-cdk-lib-2.240.0+minimatch-10.2.4.tgz`
